...
6. **AI Explanation:** Click on a critical finding (like SEC-003 Telnet). Show Gemini explaining *why* it's bad in plain English.
7. **AI Remediation:** Click "Fix this". Show Gemini generating the exact Cisco CLI commands to disable Telnet and enable SSH.
